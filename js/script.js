...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Add scroll event listener to show navbar when scrolled past hero section
    window.addEventListener('scroll', () => {
        const heroHeight = document.querySelector('.hero-container').offsetHeight;
        // Show navbar when user has scrolled to approximately where the navbar should be
